...
class bulletinBoard extends BmobObject {
  ...
  bulletinBoard();
  factory bulletinBoard.fromJson(Map<String, dynamic> json) => _$bulletinBoardFromJson(json);
...
Map<String, dynamic> _$bulletinBoardToJson(bulletinBoard instance) => <String, dynamic>{
